    ...
    return (
        <div className="w-full h-screen bg-gradient-to-b from-black to-gray-900 flex flex-col justify-center items-center px-4">
            <motion.div
                ...
                className="w-[90%] lg:max-w-[60%] h-[550px] bg-white rounded-2xl flex justify-center items-center overflow-hidden border-2 border-[#1a1f23] shadow-xl shadow-black/40"
            >
                {/* Left Form Section */}
                <form
